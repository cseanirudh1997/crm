    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="section-wrapper relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="max-w-2xl mx-auto text-center">
          <span className="section-badge mb-4 mx-auto"><Sparkles size={11} /> AI Newsletter</span>
          <h2 className="font-display text-2xl sm:text-3xl font-bold text-white mb-3">
            Practitioner-Grade <span className="gradient-text">AI Insights</span>
          </h2>
          <p className="text-gray-400 text-sm leading-relaxed mb-8">
            Join 1,300+ data scientists and AI leaders receiving weekly insights on GenAI systems, pricing AI, MLOps, and career acceleration — direct from production experience.
          </p>
          ...
          {done ? (
            <div className="glass border border-emerald-700/30 rounded-2xl p-8 bg-emerald-950/20">
              ...
              <p className="text-gray-400 text-sm">Welcome! Expect practitioner-grade AI insights in your inbox every week.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="glass border border-white/8 rounded-2xl p-6 space-y-3">
              ...
              <p className="text-xs text-gray-600">Weekly AI insights · No spam · Unsubscribe anytime</p>
            </form>
          )}
        </motion.div>
      </div>
